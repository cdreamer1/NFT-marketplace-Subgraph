...
export function createUpdateMintFeeEvent(mintFee: BigInt): UpdateMintFee {
  let updateMintFeeEvent = changetype<UpdateMintFee>(newMockEvent())

  updateMintFeeEvent.parameters = new Array()

  updateMintFeeEvent.parameters.push(
    new ethereum.EventParam(
      "mintFee",
